...
<div data-role="page">
	...
	<div class="ui-grid-b">
			<div class="ui-block-a"><button type="button" data-theme="c">好友</button></div>
			<div class="ui-block-b"><button type="button" data-theme="c">派对</button></div>	   
			<div class="ui-block-c"><button type="button" data-theme="c">系统</button></div>
		</div>
