...
public interface Message {
	...
	public static final String WWW = "http://192.168.0.103:8080/";
	
	
	public static final String URL_USER = "user.do";
	public static final String URL_MAIL = "mail.do";
	...
	public static final String SEND_MAIL_SUCCESS = "发送邮件成功";
	public static final String SEND_MAIL_FAILURE = "发送邮件失败";
