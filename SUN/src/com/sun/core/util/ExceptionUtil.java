/*
 * Copyright (c) 2011 MSC Organization
 *
 ...
 * ログの機能によっては、原因となった例外スタックトレースを 最後まで表示しない。 本機能は、原因となった例外を再帰的に取得し、
...
public final class ExceptionUtil {
	...
	/**
	 * ServletExceptionが発生した際に使用するメソッド名。 Servlet の例外が引き起こされた元になった例外を返すメソッドである。
	 */
	 ...
	 * 
	 * <p>
	 * 指定した例外の原因となった例外が取得できれば、 その例外のスタックトレースを再帰的に取得する。
