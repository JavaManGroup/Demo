...
<link href="front/css/news.css" rel="stylesheet" type="text/css" />
</head>
		...
		<div class="main_2">
			<div>
				<div class="title_left">
					<div class="title_right">
						<div class="title_middle">
							<div class="news_title">现在的位置：<a href="news.do">新闻报道</a> &gt;&gt; <a href="news.do?command=list&typeId=${news.type_id}">${news.name}</a> &gt;&gt; ${news.title}</div>
							<a href="news.do?command=list&typeId=${news.type_id}" ><div class="more"></div></a>
				...
				<div id="news_2" class="news_2"> 	
					<div class="news_3_title">${news.title }</div>
