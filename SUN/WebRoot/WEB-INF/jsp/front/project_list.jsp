...
<div id="container">
	...
	<div class="main">
		...
		<div class="main_2">
					...
					<c:forEach var="p" items="${allList.list}">
						...
						<div class="art_left">
							<div class="art_right">
								...
								<img src="${p.image_path}" width="171" height="117" />
								</a>
								</div>
							</div>
						</div>
						<table border="0" cellpadding="0" cellspacing="0"><tr><td width="186" align="center" valign="middle">${fn:substring(p.title, 0, 13)}</td></tr></table>
			...
			<x:page url="project.do?command=list&typeId=${typeMap.id}&&" paginglist="${allList}"></x:page>
		</div>
