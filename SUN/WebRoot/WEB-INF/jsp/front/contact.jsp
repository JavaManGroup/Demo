...
<div id="container">
	...
	<div class="main">
		<div style="float:left; margin-top:6px;"><img src="${base}/front/img/link.jpg" width="180" height="176" /></div>
		<div class="main_2">
			<div>
				<div class="title_left">
					<div class="title_right">
						<div class="title_middle">
							<div class="news_title">现在的位置：联系我们</div>
						</div>
					</div>
				</div>
				...
				<div id="news_2" class="news_2"> 	
					<div style="float:left; padding-left:80px; padding-top:18px;">
					...
					<div class="text" style="float:left; padding-left:40px; padding-top:18px;">
						<p>大连正泰开宇装饰有限公司</p>
						<p>地址：${contact.address}
						</p>
					</div>
