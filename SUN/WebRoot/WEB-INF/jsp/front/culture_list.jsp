	...
	<div class="main">
		...
		<div class="main_2">
			<div>
				<div class="title_left">
					<div class="title_right">
						<div class="title_middle">
							<div class="news_title">现在的位置：资格资质</div>
				...
				<c:forEach var="n" items="${list.list}" varStatus="t">
						<div class="news_text_2" ${t.last?"style='border:none'":""}>
						<p><a href="culture.do?command=detail&clid=${n.id}">${fn:substring(n.title, 0, 10)}</a></p>
			...
			<div class="page">
				<c:if test="${list.pageCount >1 }">
					...
					<a href="culture.do?command=list&&pageNum=${list.pageNum-1}&cultureId=${cultureId}">
					上一页
					</a></div>
					<div class="page_m" style="width:50px;">
						<a href="culture.do?command=list&&pageNum=${list.pageNum+1}&cultureId=${cultureId}">
				...
				当前${pageNum}页,共${list.pageCount}页
				<div class="clear"></div>
			</div>
		</div>
		<div class="clear"></div>
